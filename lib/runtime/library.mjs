...
export const createLibrary = (global) => {
  ...
  const linvail = {
    ...
    _inspect: (x) => typeof x,
    inspect(x) {
      if (this && typeof this === "object" && hasOwn(this, "_inspect")) {
        const { _inspect } = /** @type {any} */ (this);
        return _inspect(x);
      } else {
        throw new TypeError("Invalid this argument for Linvail.inspect");
      }
    },
