...
export const toInternalValueArray = (region, value) => {
  ...
  return toArray(
    {
      length: resolveNaN(
        Number(leaveValue(region, getInternal(region, value, "length", value))),
        0,
      ),
    },
    (_, index) => getInternal(region, value, index, value),
  );
};
