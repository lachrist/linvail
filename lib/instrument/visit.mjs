...
/**
 * @type {(
 *   node: import("./types").Program<unknown>,
...
/**
 * @type {<T>(
 *   node: import("./types").Program<T>,
 *   hidden: string,
 * ) => import("./types").Program<T>}
 */
...
/**
 * @type {<T>(
 *   node: import("./types").SegmentBlock<T>,
 *   kind: "catch" | "other",
 * ) => import("./types").SegmentBlock<T>}
 */
 ...
 * @type {<T>(
 *   node: (
 *     & import("./types").RoutineBlock<T>
 *     & { head: import("./types").Effect<T>[] }
 *   ),
 *   kind: (
 *     | "generator"
 *     | "async-generator"
 ...
 *   tag: T,
 * ) => (
 *   inner: import("./types").Effect<T>,
 * ) => import("./types").Statement<T>}
 */
...
/**
 * @type {<T>(
 *   node: import("./types").RoutineBlock<T> & { head: null },
 *   kind: import("aran").ProgramKind,
 *   hidden: string,
 * ) => import("./types").RoutineBlock<T> & { head: null }}
 */
...
/**
 * @type {<T>(
 *   node: import("./types").Effect<T>,
 * ) => import("./types").Effect<T>}
 */
...
/**
 * @type {<T>(
 *   node: import("./types").Expression<T>,
 * ) => import("./types").Expression<T>}
 */
  ...
  switch (node.type) {
    ...
    case "EvalExpression": {
      return {
        ...
        code: intercept(
          "weaveEvalProgram",
          intercept("leaveValue", visitExpression(node.code), node.tag),
          node.tag,
        ),
      };
    }
