...
export const array_apply_oracle_mapping = {
  ...
  //   const length = getLength(region, target);
  //   const index = incrementWhenNegative(
  //   let index1 = clampInteger(region, atExternal(region, input, 1));
  //   index1 = clamp(index1 < 0 ? index1 + length : index1, 0, length);
  //   let index2 = clampInteger(region, atExternal(region, input, 2));
  //   index2 = clamp(index2 < 0 ? index2 + length : index2, 0, length);
  //   let index3 = clampInteger(region, atExternal(region, input, 3));
  //   index3 = clamp(index3 < 0 ? index3 + length : index3, 0, length);
  // },
