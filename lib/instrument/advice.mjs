...
const toAdviceVariable = (name) =>
  /** @type {import("./node").Variable} */ (`.${name}`);

/**
 * @type {(
 *   name: keyof import("../advice").Advice,
 * ) => [import("./node").Variable, import("aran").Intrinsic]}
 */
const toAdviceBinding = (name) => [toAdviceVariable(name), "undefined"];

/**
 * @type {[import("./node").Variable, import("aran").Intrinsic]}
 */
...
/**
 * @type {<T>(
 *   convertion: import("./convertion").Convertion,
 *   target: import("./node").Expression<T>,
 *   tag: T,
...
/**
 * @type {<T>(
 *   callee: import("./node").Expression<T>,
 *   that: import("./node").Expression<T>,
 *   args: import("./node").Expression<T>[],
 *   tag: T,
 * ) => import("./node").Expression<T>}
 */
