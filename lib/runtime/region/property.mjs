 ...
 *   target: import("../domain.d.ts").PlainInternalReference,
 *   key: PropertyKey
 ...
 * ) => import("../domain.d.ts").ExternalDefineDescriptor}
 */
 ...
 * @type {<O, K>(
 *   region: import("./region.d.ts").Region,
 *   old_descriptor: undefined | import("../domain.d.ts").InternalDescriptor,
 *   new_descriptor: import("../domain.d.ts").InternalDefineDescriptor,
