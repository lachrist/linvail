...
export const object_apply_oracle_mapping = {
  ...
  "global.Object.entries": (region, _that, input) => {
    ...
    const entries = enterPlainInternalArrayWithExternalPrototype(
      region,
      new Array(0),
    );
    let length = 0;
      ...
      if (typeof key === "string") {
        ...
        if (descriptor && descriptor.enumerable) {
          defineProperty(entries, length, {
            __proto__: null,
            value: enterPlainInternalArrayWithExternalPrototype(
              region,
              createArray(
  ...
  "global.Object.getOwnPropertyNames": (region, _that, input) => {
    ...
    const keys = listInternalOwnPropertyKey(region, target);
    const strings = enterPlainInternalArrayWithExternalPrototype(
      region,
      new Array(0),
    );
    let length = 0;
  ...
  "global.Object.groupBy": (region, _that, input) => {
    ...
    while (!done) {
      ...
      if (!done) {
        ...
        if (!group) {
          group = enterPlainInternalArrayWithExternalPrototype(
            region,
            new Array(0),
          );
          groups[key] = group;
  ...
  "global.Object.keys": (region, _that, input) => {
    ...
    const keys = listInternalOwnPropertyKey(region, target);
    const result = enterPlainInternalArrayWithExternalPrototype(
      region,
      new Array(0),
    );
    let length = 0;
