...
/**
 * @type {<K1, K2>(
 *   collection: import("./collection.d.ts").Set<K1>,
 *   key: K2,
 * ) => boolean}
 */
...
/**
 * @type {<T, K>(
 *   collection: import("./collection.d.ts").Set<K>,
 *   callback: (
 *     this: T,
 *     val: K,
 *     key: K,
 *    set: import("./collection.d.ts").Set<K>,
 *   ) => void,
 *   this_arg: T,
 * ) => void}
 */
 ...
 *   keys: K[],
 * ) => import("./collection.d.ts").WeakSet<K>}
 */
 ...
 *   collection: import("./collection.d.ts").WeakSet<K1>,
 *   key: K2,
 * ) => boolean}
 */
 ...
 *   collection: import("./collection.d.ts").WeakSet<K1>,
 *   key: K2,
 * ) => import("./collection.d.ts").WeakSet<K1>}
 */
 ...
 * @type {<K, V>(
 *   entries: [K, V][],
 * ) => import("./collection.d.ts").Map<K, V>}
 */
...
/**
 * @type {<K1, V1, K2>(
 *   collection: import("./collection.d.ts").Map<K1, V1>,
 *   key: K2,
 * ) => boolean}
 */
 ...
 *   key: K2,
 *   val: V2,
 * ) => import("./collection.d.ts").Map<K1, V1>}
 */
...
/**
 * @type {<K, V>(
 *   collection: import("./collection.d.ts").Map<K, V>,
 * ) => void}
 */
 ...
 *     val: V,
 *     key: K,
 *     map: import("./collection.d.ts").Map<K, V>,
 *   ) => void,
 *   this_arg: T,
 * ) => void}
 */
 ...
 *   entries: [K, V][],
 * ) => import("./collection.d.ts").WeakMap<K, V>}
 */
 ...
 *   collection: import("./collection.d.ts").WeakMap<K1, V1>,
 *   key: K2,
 * ) => undefined | V1}
 */
 ...
 *   key: K2,
 *   val: V2,
 * ) => import("./collection.d.ts").WeakMap<K1, V1>}
 */
