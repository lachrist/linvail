 ...
 * >}
 */
export const object_construct_oracle_mapping = {
  "global.Object": (region, input, new_target) => {
    const {
      "global.Object": Object,
      "global.Object.prototype": object_prototype,
    } = region;
    if (new_target.base === Object) {
      ...
      if (internal.type === "primitive") {
        return enterReference(region, Object(internal.base));
      } else {
        return internal;
      }
    } else {
      ...
      if (prototype.type === "primitive") {
        ...
        return createEmptyObject(region, prototype.base);
      }
    }
  },
};
...
export const object_apply_oracle_mapping = {
  "global.Object": (region, _that, input) => {
    const {
      "global.Object": Object,
      "global.Object.prototype": object_prototype,
    } = region;
  ...
  "global.Object.prototype": null, // not a function
  ...
  "global.Object.create": (region, _that, input) => {
    ...
    if (raw_property_record.base === undefined) {
        ...
        if (descriptor && descriptor.enumerable) {
          defineProperty(entries.plain, length, {
            ...
            value: createFullArray(region, [
              enterStandardPrimitive(region, key),
  ...
  "global.Object.freeze": null, // no benefit
  "global.Object.fromEntries": (region, _that, input) => {
    ...
    while (!done) {
      ...
      done = !!getInternalPropertyValue(region, step, "done", step).base;
      if (!done) {
        ...
        try {
          ...
          key = toPropertyKey(region, entry0.base);
          val = entry1;
        } catch (error) {
          closeIterator(region, iterator);
          throw error;
    ...
    for (let index = 0; index < keys.length; index++) {
      ...
      if (typeof key === "string") {
        defineProperty(strings.plain, length, {
          __proto__: null,
          value: enterStandardPrimitive(region, key),
          writable: true,
          enumerable: true,
          configurable: true,
        });
  ...
  "global.Object.getPrototypeOf": null, // no benefit
  "global.Object.groupBy": (region, _that, input) => {
    ...
    if (typeof callback.base !== "function") {
      ...
      if (!done) {
        ...
        const key = toPropertyKey(
          ...
          applyInternal(
            ...
            [item, enterStandardPrimitive(region, index++)],
          ).base,
        );
  ...
  "global.Object.hasOwn": null, // no benefit
  "global.Object.is": null, // no benefit
  "global.Object.isExtensible": null, // no benefit
  "global.Object.isFrozen": null, // no benefit
  "global.Object.isSealed": null, // no benefit
  ...
  "global.Object.preventExtensions": null, // no benefit
  "global.Object.seal": null, // no benefit
  "global.Object.setPrototypeOf": null, // no benefit
