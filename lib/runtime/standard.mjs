...
export const toStandardAdvice = ({
  ...
  "block@declaration-overwrite": (_state, kind, frame, _tag) => {
    /** @type {{[k in string]: import("./domain.d.ts").InternalValue}} */
      ...
      for (const variable in frame) {
        if (variable === "function.callee") {
          ...
          copy[variable] = enterArgumentList(
            /** @type {import("./domain.d.ts").PlainInternalArrayWithExternalPrototype} */ (
          ...
          copy[variable] = enterValue(
            /** @type {import("./domain.d.ts").ExternalValue} */ (
              frame[variable]
            ),
          );
        } else {
  ...
  "await@after": (_state, value, _tag) =>
    enterValue(/** @type {import("./domain.d.ts").ExternalValue} */ (value)),
  ...
  "closure@after": (_state, kind, closure, _tag) =>
    enterClosure(
      /** @type {import("./domain.d.ts").RawPlainInternalClosure} */ (
