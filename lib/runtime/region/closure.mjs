...
import { enterStandardPrimitive, enterReference } from "./core.mjs";
...
export const enterFreshHostClosure = (region, closure, kind) => {
  ...
  if (kind === "function") {
    if (
      !defineProperty(wrapper.plain, "prototype", {
        __proto__: null,
        value: enterStandardPrimitive(region, null),
        enumerable: false,
        configurable: false,
        writable: true,
      })
    ...
    if (
      !defineProperty(wrapper.plain, "prototype", {
        __proto__: null,
        ...descriptor,
        value: enterReference(region, descriptor.value),
      })
    ) {
      throw new LinvailExecError(
  ...
  if (
    !defineProperty(wrapper.plain, "length", {
      __proto__: null,
      value: enterStandardPrimitive(region, 0),
      writable: false,
      enumerable: false,
      configurable: true,
    })
  ...
  if (
    !defineProperty(wrapper.plain, "name", {
      __proto__: null,
      value: enterStandardPrimitive(region, ""),
      writable: false,
      enumerable: false,
      configurable: true,
    })
...
const enterRawHostGeneratorResult = (region, result, default_prototype) => {
  ...
  const wrapper = enterReference(region, /** @type {any} */ (result));
  ...
  if (
    !setPrototypeOf(
      wrapper.base,
      prototype.type === "primitive" ? default_prototype : prototype.base,
    )
  ) {
...
export const applyHostReference = (region, callee, that, args) => {
  ...
  switch (callee.kind) {
    ...
    case "async-arrow": {
      return enterReference(region, apply(callee.plain, that, args));
    }
    case "async-function": {
      return enterReference(region, apply(callee.plain, that, args));
    }
 ...
 * ) => import("../domain.d.ts").HostReferenceWrapper<K>}
 */
export const enterHostClosure = ({ host_closure_registery }, closure) =>
