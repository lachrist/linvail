...
export const application = {
  ...
  "aran.get": (
    ...
    _that,
    args,
    { release, externalizeReference: externalizeReference },
  ) =>
    callee(
  ...
  "aran.createObject": (
    ...
    args,
    {
      ...
      capture,
      release,
      externalizeReference: externalizeReference,
    },
  ) => {
  ...
  "Reflect.get": (
    ...
    _that,
    args,
    { capture, release, externalizeReference: externalizeReference },
  ) =>
    callee(
      atValue(args, 0, release),
      leave(atValue(args, 1, release), externalizeReference),
  ...
  "Reflect.getOwnPropertyDescriptor": (
    ...
    args,
    {
      capture,
      release,
      internalizeReference: internalizeReference,
      externalizeReference: externalizeReference,
      intrinsics,
    },
  ) =>
  ...
  "Reflect.ownKeys": (
    ...
    for (let index = 1; index < length; index++) {
      array[index] = capture(array[index]);
    }
    intrinsics["Reflect.setPrototypeOf"](
      array,
      internalizeReference(intrinsics["Array.prototype"]),
    );
    return array;
  },
  // Array //
  "Array.of": (
    ...
    _that,
    args,
    { internalizeReference: internalizeReference, intrinsics },
  ) => {
