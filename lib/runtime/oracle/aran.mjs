...
export const aran_apply_oracle_mapping = {
  ...
  "aran.toArgumentList": (region, _that, input) => {
    ...
    if (
      !defineProperty(result.plain, "length", {
        __proto__: null,
        value: enterStandardPrimitive(region, length),
        writable: true,
        enumerable: false,
        configurable: true,
      })
    ...
    if (
      !defineProperty(result.plain, iterator_symbol, {
        __proto__: null,
        value: enterReference(region, array_iterator),
        writable: true,
        enumerable: false,
        configurable: true,
      })
    ...
    if (
      !defineProperty(result.plain, to_string_tag_symbol, {
        __proto__: null,
        value: enterStandardPrimitive(region, "Arguments"),
        writable: true,
        enumerable: false,
        configurable: true,
      })
  ...
  "aran.listForInKey": (region, _that, input) => {
    ...
    if (
      !defineProperty(result.plain, "length", {
        __proto__: null,
        value: enterStandardPrimitive(region, result_length),
        writable: true,
        enumerable: true,
        configurable: true,
      })
