...
export const array_construct_oracle_mapping = {
  "global.Array": (region, input, new_target) => {
    ...
    if (prototype.type !== "primitive") {
      if (!setPrototypeOf(result.plain, prototype.base)) {
...
export const array_apply_oracle_mapping = {
          ...
          if (hasInternalProperty(region, current, index)) {
            ...
            if (
              !defineInternalPropertyDescriptor(region, result, "length", {
                __proto__: null,
                value: enterStandardPrimitive(region, result_length + 1),
                writable: true,
                enumerable: false,
                configurable: false,
              })
    ...
    for (let index = 0; index < length; index++) {
      if (hasInternalProperty(region, target, index)) {
        if (
          ...
          return enterStandardPrimitive(region, false);
        }
      }
    }
    return enterStandardPrimitive(region, true);
  },
  ...
  "global.Array.prototype.filter": (region, that, input) => {
    ...
    while (arg_index < target_length) {
      if (hasInternalProperty(region, target, arg_index)) {
        ...
        if (
          applyInternal(region, predicate, this_arg, [
            item,
            enterStandardPrimitive(region, arg_index),
            target,
          ]).base
        ) {
          if (
    ...
    if (
      !defineInternalPropertyDescriptor(region, result, "length", {
        __proto__: null,
        value: enterStandardPrimitive(region, res_index),
        writable: true,
        enumerable: false,
        configurable: false,
      })
  ...
  "global.Array.prototype.findIndex": (region, that, input) => {
    ...
    for (let index = 0; index < length; index++) {
      if (
        ...
        return enterStandardPrimitive(region, index);
      }
    }
    return enterStandardPrimitive(region, -1);
  },
    ...
    if (length === 0) {
      if (
        !setInternalPropertyValue(
          ...
          target,
          "length",
          enterStandardPrimitive(region, 0),
          target,
        )
      ) {
      ...
      if (
        !setInternalPropertyValue(
          ...
          target,
          "length",
          enterStandardPrimitive(region, length - 1),
          target,
        )
      ) {
        throw new TypeError("Cannot set array length at Array.prototype.pop");
  ...
  "global.Array.prototype.push": (region, that, input) => {
    ...
    if (
      !setInternalPropertyValue(
        ...
        target,
        "length",
        enterStandardPrimitive(region, length + input.length),
        target,
      )
    ) {
      throw new TypeError("Cannot set array length at Array.prototype.push");
    }
    return enterStandardPrimitive(region, length + input.length);
  },
  ...
  "global.Array.prototype.splice": (region, that, input) => {
    ...
    if (
      !setInternalPropertyValue(
        ...
        result,
        "length",
        enterStandardPrimitive(region, delete_count),
        result,
      )
    ) {
  ...
  "global.Array.prototype.unshift": (region, that, input) => {
    ...
    if (
      !setInternalPropertyValue(
        ...
        target,
        "length",
        enterStandardPrimitive(region, new_length),
        target,
      )
    ) {
      throw new TypeError("Cannot set array length at Array.prototype.unshift");
    }
    return enterStandardPrimitive(region, new_length);
  },
