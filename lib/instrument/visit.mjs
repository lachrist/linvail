...
/**
 * @type {(
 *   node: import("./node").Program<unknown>,
...
/**
 * @type {<T>(
 *   node: import("./node").Program<T>,
 *   hidden: string,
 * ) => import("./node").Program<T>}
 */
...
/**
 * @type {<T>(
 *   node: import("./node").SegmentBlock<T>,
 *   kind: "catch" | "other",
 * ) => import("./node").SegmentBlock<T>}
 */
 ...
 * @type {<T>(
 *   node: (
 *     & import("./node").RoutineBlock<T>
 *     & { head: import("./node").Effect<T>[] }
 *   ),
 *   kind: (
 *     | "generator"
 *     | "async-generator"
 ...
 *   tag: T,
 * ) => (
 *   inner: import("./node").Effect<T>,
 * ) => import("./node").Statement<T>}
 */
...
/**
 * @type {<T>(
 *   node: import("./node").RoutineBlock<T> & { head: null },
 *   kind: import("aran").ProgramKind,
 *   hidden: string,
 * ) => import("./node").RoutineBlock<T> & { head: null }}
 */
...
/**
 * @type {<T>(
 *   node: import("./node").Expression<T>,
 * ) => import("./node").Expression<T>}
 */
