...
const toAdviceVariable = (name) =>
  /** @type {import("./types").Variable} */ (`.${name}`);

/**
 * @type {(
 *   name: keyof import("../advice").Advice,
 * ) => [import("./types").Variable, import("aran").Intrinsic]}
 */
const toAdviceBinding = (name) => [toAdviceVariable(name), "undefined"];

/**
 * @type {[import("./types").Variable, import("aran").Intrinsic]}
 */
...
/**
 * @type {<T>(
 *   convertion: import("./types").Convertion,
 *   target: import("./types").Expression<T>,
 *   tag: T,
...
/**
 * @type {<T>(
 *   callee: import("./types").Expression<T>,
 *   that: import("./types").Expression<T>,
 *   args: import("./types").Expression<T>[],
 *   tag: T,
 * ) => import("./types").Expression<T>}
 */
