...
import { createEmptyArray, createFullArray } from "../region/create.mjs";
import { setHostPrototype } from "../region/access.mjs";
 ...
 * >}
 */
export const array_oracle_record = {
  "global.Array": {
    construct: (region, input, new_target) => {
      const argument0 = atExternal(region, input, 0);
      /** @type {import("../domain.d.ts").HostReferenceWrapper<"array">} */
      let result;
      ...
      if (input.length === 1 && typeof argument0 === "number") {
        ...
        if (argument0 !== length) {
          throw new region["global.RangeError"](
            "Invalid array length at Array",
          );
        }
      ...
      if (prototype.type !== "primitive") {
        if (!setHostPrototype(region, result, prototype)) {
  ...
  "global.Array.isArray": void_oracle, // no benefit,
  "global.Array.of": {
    construct: null,
    apply: (region, _that, input) => createFullArray(region, input),
  },
  "global.Array.prototype": void_oracle, // not a function
  ...
  "global.Array.prototype.entries": void_oracle, // returns exotic array iterator object
  ...
  "global.Array.prototype.includes": void_oracle, // no benefit
  "global.Array.prototype.indexOf": void_oracle, // no benefit
  "global.Array.prototype.join": void_oracle, // no benefit
  "global.Array.prototype.keys": void_oracle, // returns exotic array iterator object
  "global.Array.prototype.lastIndexOf": void_oracle, // no benefit
  "global.Array.prototype.length": void_oracle, // not a function
    ...
    apply: (region, that, _input) => {
      ...
      if (length === 0) {
        ...
        if (!deleteInternalOwnProperty(region, target, length - 1)) {
          throw new TypeError(
            "Cannot delete array index at Array.prototype.pop",
          );
        }
        if (
          !setInternalPropertyValue(
    ...
    apply: (region, that, _input) => {
      ...
      if (length === 0) {
        if (
          ...
          throw new TypeError(
            "Cannot set array length at Array.prototype.shift",
          );
        }
        return wrapStandardPrimitive(region, undefined);
      }
    ...
    apply: (region, that, input) => {
      ...
      if (argument0.type === "primitive") {
        if (argument0.inner !== undefined) {
          throw new TypeError(
            "Invalid compare function at Array.prototype.sort",
          );
        }
      } else {
      ...
      for (let index = 0; index < target_length; index++) {
        if (index < copy_length) {
          if (
            ...
            throw new TypeError(
              "Cannot set array index at Array.prototype.sort",
            );
          }
        } else {
          if (!deleteInternalOwnProperty(region, target, index)) {
  ...
  "global.Array.prototype.splice": {
    ...
    apply: (region, that, input) => {
      ...
      if (
        ...
        throw new TypeError(
          "Cannot set array length at Array.prototype.splice",
        );
      }
      if (item_count < delete_count) {
        for (
          ...
          if (hasInternalProperty(region, target, index + delete_count)) {
            ...
            if (
              !deleteInternalOwnProperty(region, target, index + item_count)
            ) {
              throw new TypeError(
  ...
  "global.Array.prototype.toLocaleString": void_oracle, // no benefit
  ...
  "global.Array.prototype.toString": void_oracle, // no benefit
    ...
    apply: (region, that, input) => {
      ...
      for (let index = target_length - 1; index >= 0; index--) {
        if (hasInternalProperty(region, target, index)) {
          ...
          if (
            !deleteInternalOwnProperty(region, target, index + input_length)
          ) {
            throw new TypeError(
      ...
      if (
        ...
        throw new TypeError(
          "Cannot set array length at Array.prototype.unshift",
        );
      }
      return wrapStandardPrimitive(region, new_length);
    },
  },
  "global.Array.prototype.values": void_oracle, // returns exotic array iterator object
    ...
    apply: (region, that, input) => {
      ...
      if (match < 0 || match >= length) {
        throw new RangeError(
          "Array index out of range at Array.prototype.with",
        );
      }
