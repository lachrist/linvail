...
// Internal|External Object|Array >> Missing //
for (const target of [
  { __proto__: null },
...
// // Existing Non-Configurable Property //
// {
//   const target = {};
//   assertEqual(
...
// // Existing Property In Prototype //
// {
//   const target = { __proto__: { __proto__: null, foo: 123 } };
//   assertEqual(Reflect.set(target, "foo", 456), true);
//   assertEqualDescriptor(Reflect.getOwnPropertyDescriptor(target, "foo"), {
//     value: 456,
//     writable: true,
...
//     true,
//   );
//   assertEqual(Reflect.set(target, "foo", 789), true);
//   assertEqualDescriptor(Reflect.getOwnPropertyDescriptor(target, "foo"), {
//     value: 789,
//     writable: true,
//     enumerable: true,
...
// // Internal Setter Object //
// {
//   const target = {
//     set foo(/** @type {unknown} */ val) {
//       /** @type {any} */ (this).bar = val;
//     },
//   };
//   const receiver = { bar: 123 };
//   assertEqual(Reflect.set(target, "foo", 456, receiver), true);
//   assertEqual(receiver.bar, 456);
// }

// // Internal Setter Array //
// {
//   /** @type {any} */
//   const target = [];
//   assertEqual(
...
// {
//   const receiver = { bar: 123 };
//   const external = evalGlobal("({ set foo (val) { this.bar = val; } });");
//   assertEqual(Reflect.set({ __proto__: external }, "foo", 456, receiver), true);
//   assertEqual(receiver.bar, 456);
// }

// {
//   const external = evalGlobal("({});");
//   Reflect.defineProperty(external, "foo", {
//     set(val) {
//       this.bar = val;
//     },
//     configurable: false,
...
// {
//   const internal = {};
//   Reflect.defineProperty(internal, "foo", {
//     set: evalGlobal("(function (val) { this.bar = val; });"),
//     configurable: false,
//     enumerable: false,
//   });
//   const receiver = { bar: 123 };
//   assertEqual(Reflect.set({ __proto__: internal }, "foo", 456, receiver), true);
//   assertEqual(receiver.bar, 456);
// }
