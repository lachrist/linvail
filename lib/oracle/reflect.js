...
module.exports = (membrane, access, oracle) => {
  ...
  oracle.set(Reflect_get, function () {
    ...
    if (Array_isArray($object0) && String(value1) === "length") {
      ...
      return membrane.taint(number);
    }
    if (Hold($object0, value1)) {
      let $$valueR;
      if (arguments.length > 2) {
        const $$value2 = arguments[2];
        valueR = Reflect_get($object0, value1, $$value2);
      } else {
        const $$value0 = arguments.length > 0 ? arguments[0] : membrane.taint(void 0);
        valueR = Reflect_get($object0, value1, $$value0);
      }
      return valueR;
    }
  ...
  oracle.set(Reflect_set, function () {
    ...
    if (Array_isArray($value0) && String(value1) === "length") {
      ...
      return membrane.taint(true);
    }
    const $$value2 = arguments.length > 2 ? arguments[2] : membrane.taint(void 0);
    let booleanR;
    if (Hold($value0, value1)) {
      if (arguments.length > 3) {
        const $$value3 = arguments[3];
        booleanR = Reflect_set($value0, value1, $$value2, $$value3);
      } else {
        const $$value0 = arguments.length > 0 ? arguments[0] : membrane.taint(void 0);
        booleanR = Reflect_set($value0, value1, $$value2, $$value0);
      }
    } else {
      if (arguments.lengt > 3) {
        const $value3 = membrane.clean(arguments[3]);
        booleanR = Reflect_set($value0, value1, $$value2, $value3);
      } else {
        booleanR = Reflect_set($value0, value1, $$value2, $value0);
      }
