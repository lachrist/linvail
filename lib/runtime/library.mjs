...
const compileWeaMapConstructor = (global) => {
  ...
  const WeakMapPrototype = {
    ...
    set(key, value) {
      return /** @type {import("./library").LinvailWeakMap} */ (
        /** @type {unknown} */ (apply(setWeakMap, this, [key, value]))
      );
    },
    has(key) {
...
const compileWeakSetConstructor = (global) => {
  ...
  const WeakSetPrototype = {
    ...
    add(value) {
      return /** @type {import("./library").LinvailWeakSet} */ (
        /** @type {unknown} */ (apply(addWeakSet, this, [value]))
      );
    },
    delete(value) {
...
const compileMapConstructor = (global) => {
  ...
  const MapPrototype = {
    ...
    set(key, value) {
      return /** @type {import("./library").LinvailMap} */ (
        /** @type {unknown} */ (apply(setMap, this, [key, value]))
      );
    },
    delete(key) {
    ...
    clear() {
      return /** @type {undefined} */ (apply(clearMap, this, []));
    },
...
const compileSetConstructor = (global) => {
  ...
  const SetPrototype = {
    ...
    add(key) {
      return /** @type {import("./library").LinvailSet} */ (
        /** @type {unknown} */ (apply(addSet, this, [key]))
      );
    },
    delete(key) {
