...
export const array_apply_oracle_mapping = {
  ...
  "global.Array.prototype.reverse": (region, that, _input) => {
    ...
    for (let index = 0; index < middle; index++) {
      ...
      const lower_value = hasInternalProperty(
        region,
        target_reference,
        lower_index,
      )
        ...
        : {};
      const upper_value = hasInternalProperty(
        region,
        target_reference,
        upper_index,
      )
      ...
      if (hasOwnNarrow(upper_value, "inner")) {
        ...
        if (!deleteInternalOwnProperty(region, target_reference, lower_index)) {
          throw new TypeError(
      ...
      if (hasOwnNarrow(lower_value, "inner")) {
        ...
        if (!deleteInternalOwnProperty(region, target_reference, upper_index)) {
          throw new TypeError(
            "Cannot delete array index at Array.prototype.reverse",
          );
        }
  ...
  //       ) {
  //         throw new TypeError(
  //           "Cannot set array index at Array.prototype.toReversed",
  //         );
  //       }
  //     }
  //   }
