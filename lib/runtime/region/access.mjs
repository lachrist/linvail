...
// // We can try to detect cycles but it is never going to be perfect.
// // Plus, this detection method will trigger getPrototypeOf on proxy trap.
// // Whereas is should stop upon encountering a proxy.
//
// /**
//  * @type {(
//  *   region: import("../region.d.ts").Region,
...
//       } else if (current.type === "host") {
//         current = wrapPrototype(region, getPrototypeOf(current.plain));
//       } else {
//         throw new LinvailTypeError(current);
//       }
//     }
