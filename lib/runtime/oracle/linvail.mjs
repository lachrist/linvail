 ...
 *   (
 *     | `linvail.${"is" | "dir"}`
 *     | `linvail.Map.prototype.${keyof import("../../library/library").LinvailMapPrototype}`
 *     | `linvail.Set.prototype.${keyof import("../../library/library").LinvailSetPrototype}`
 *     | `linvail.WeakMap.prototype.${keyof import("../../library/library").LinvailWeakMapPrototype}`
 *     | `linvail.WeakSet.prototype.${keyof import("../../library/library").LinvailWeakSetPrototype}`
 *   ),
