import { advice_name_record } from "../runtime/advice/custom.mjs";
...
/**
 * @type {(
 *   name: "" | keyof import("../runtime/advice/custom.js").CustomAdvice,
...
export const interceptClosure = (target, kind, tag) => ({
  ...
  callee: {
    type: "ReadExpression",
    variable: toAdviceVariable("wrapFreshHostClosure"),
    tag,
  },
  this: {
    type: "IntrinsicExpression",
