...
let __ARAN_var__apply,
  ...
  __ARAN_var_Linvail = __ARAN_itr["aran.deadzone"],
...
__ARAN_var_Linvail = __ARAN_var__apply(
  ...
  [
    __ARAN_var__apply(
      ...
      __ARAN_var__capture(__ARAN_var__internalize(__ARAN_itr["undefined"])),
      [__ARAN_var__capture("globalThis")],
    ),
    __ARAN_var__capture("Linvail"),
  ],
);
__ARAN_var_xs = __ARAN_var__apply(
  __ARAN_var__capture(__ARAN_var__internalize(__ARAN_itr["Array.of"])),
  __ARAN_var__capture(__ARAN_var__internalize(__ARAN_itr["undefined"])),
  [],
);
__ARAN_var__externalize(
  __ARAN_var__release(
    ...
    __ARAN_var__apply(
      ...
      __ARAN_var__r_4220,
      [
        ((__ARAN_var__r_431220 = __ARAN_var_Linvail),
        __ARAN_var__apply(
          __ARAN_var__apply(
            __ARAN_var__capture(
            ...
            [__ARAN_var__r_431220, __ARAN_var__capture("inspect")],
          ),
          ...
          [
            __ARAN_var__apply(
              ...
              [__ARAN_var_xs, __ARAN_var__capture("length")],
            ),
          ],
        )),
      ],
